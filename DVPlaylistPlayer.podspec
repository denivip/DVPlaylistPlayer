#
# Be sure to run `pod spec lint DVPlaylistPlayer.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "Mikhail Grushin" => "grushin@denivip.ru", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Mikhail Grushin', 'other author'
